...
export default function Navbar({ activeTab, setActiveTab }: NavbarProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-card border-b border-border shadow-sm">
      ...
      <div className="overflow-x-auto no-scrollbar border-t border-border/50 bg-card">
        <div className="flex items-center gap-1.5 px-3 py-1.5 w-max min-w-full">
          {TABS.map(tab => (
            <button
              key={tab}
